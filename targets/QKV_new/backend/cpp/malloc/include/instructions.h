...
class Load01 : public Instruction {
private:
  int64 n;

  IntVar *addr_in = MAKE_INT_VAR(INT64_MIN, INT64_MAX);
  IntVar *addr_out = MAKE_INT_VAR(INT64_MIN, INT64_MAX);
...
public:
  Load01(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("load_01", y, X), n(n) {
  }

  std::string str() override {
    return op_name + "(n = " + std::to_string(n) + ", addr_in = " + std::to_string(addr_in->Value()) + ", addr_out = " + std::to_string(addr_out->Value()) + "" + ")";
  }
  ...
  std::vector<IntVar *> get_int_var() override { return {addr_in, addr_out}; }
};

class Load03 : public Instruction {
private:
  int64 n;
...
public:
  Load03(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("load_03", y, X), n(n) {
  }
...
class Store10 : public Instruction {
private:
  int64 n;
  ...
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h0() {
    return {{addr_out, MAKE_SUM(addr_out, n * 128)}};
  }
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h1() {
    return {{addr_in, MAKE_SUM(addr_in, n)}};
  }

public:
  Store10(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("store_10", y, X), n(n) {
  }
...
class Store30 : public Instruction {
private:
  int64 n;
...
public:
  Store30(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("store_30", y, X), n(n) {
  }
...
class Transpose13 : public Instruction {
private:
  ...
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h0() {
    return {{addr_out, MAKE_SUM(addr_out, 64)}};
  }
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h1() {
    return {{addr_in, MAKE_SUM(addr_in, 64)}};
  }

public:
  Transpose13(Tensor *y, std::vector<Tensor *> X)
      : Instruction("transpose_13", y, X) {
  }

  std::string str() override {
    return op_name + "(addr_in = " + std::to_string(addr_in->Value()) + ", addr_out = " + std::to_string(addr_out->Value()) + "" + ")";
  }
...
class Mov21 : public Instruction {
private:
  int64 n;
...
public:
  Mov21(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("mov_21", y, X), n(n) {
  }
...
class Mov23 : public Instruction {
private:
  int64 n;
...
public:
  Mov23(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("mov_23", y, X), n(n) {
  }
...
class Gemm33 : public Instruction {
private:

  IntVar *addr_1 = MAKE_INT_VAR(INT64_MIN, INT64_MAX);
  IntVar *addr_2 = MAKE_INT_VAR(INT64_MIN, INT64_MAX);
  IntVar *addr_out = MAKE_INT_VAR(INT64_MIN, INT64_MAX);
  ...
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h1() {
    return {{addr_1, MAKE_SUM(addr_1, 64)}};
  }
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h2() {
    return {{addr_2, MAKE_SUM(addr_2, 64)}};
  }

public:
  Gemm33(Tensor *y, std::vector<Tensor *> X)
      : Instruction("gemm_33", y, X) {
  }

  std::string str() override {
    return op_name + "(addr_1 = " + std::to_string(addr_1->Value()) + ", addr_2 = " + std::to_string(addr_2->Value()) + ", addr_out = " + std::to_string(addr_out->Value()) + "" + ")";
  }
  ...
  std::vector<IntVar *> get_int_var() override { return {addr_1, addr_2, addr_out}; }
};

class Gemm13 : public Instruction {
private:
...
public:
  Gemm13(Tensor *y, std::vector<Tensor *> X)
      : Instruction("gemm_13", y, X) {
  }
...
class Softmax : public Instruction {
private:
  int64 n;

  IntVar *addr = MAKE_INT_VAR(INT64_MIN, INT64_MAX);

  std::vector<std::pair<IntExpr *, IntExpr *>> get_h0() {
    return {{addr, MAKE_SUM(addr, n)}};
  }
  std::vector<std::pair<IntExpr *, IntExpr *>> get_h1() {
    return {{addr, MAKE_SUM(addr, n)}};
  }
...
public:
  Softmax(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("softmax", y, X), n(n) {
  }

  std::string str() override {
    return op_name + "(n = " + std::to_string(n) + ", addr = " + std::to_string(addr->Value()) + "" + ")";
  }
  ...
  std::vector<IntVar *> get_int_var() override { return {addr}; }
};
