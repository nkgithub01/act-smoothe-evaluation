...
def semantic_init(hbm_size):
	...
	prologue.append(f'%d3.0 = bf16[128,64]{{1,0}} constant(0)')
...
def load_01(n,addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	...
	if mode == 'fsim':
		...
		print(f'load_01(n,addr_in,addr_out)')
		print([n,addr_in,addr_out])

def load_03(n,addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
			"n": n,
	...
	if mode == 'fsim':
		...
		lvars['Out0'] = lhs_loc
		rhs_update = parameter_util(global_counters,  attrs, state, lvars, comp_attrs, 'Out0')
		rhs_loc = parameter_util(global_counters,  attrs, state, lvars, comp_attrs, 'd3')
		lhs_loc, lhs_type = lhs_util(attrs, state, global_counters, lvars, comp_attrs, 'd3')
		start_indices = ['@a.addr_out','0']
		lines = slice_store(lhs_loc, lhs_type, rhs_loc, rhs_update, start_indices,
							attrs, state, lvars, comp_attrs, global_counters['start_counter'])
		global_counters["start_counter"] += 1
		...
		print(f'load_03(n,addr_in,addr_out)')
		print([n,addr_in,addr_out])

def store_10(n,addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
			"n": n,
	...
	if mode == 'fsim':
		...
		print(f'store_10(n,addr_in,addr_out)')
		print([n,addr_in,addr_out])

def store_30(n,addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
			"n": n,
	...
	if mode == 'fsim':
		...
		print(f'store_30(n,addr_in,addr_out)')
		print([n,addr_in,addr_out])

def transpose_13(addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
	...
	if mode == 'fsim':
		...
		slice_configs = ['@a.addr_in:@a.addr_in+64','0:64']
		line = slice_load(lhs_loc, lhs_type, rhs_loc, slice_configs, attrs, state, lvars, comp_attrs)
		output.append(line)


		in_loc = parameter_util(global_counters,  attrs, state, lvars, comp_attrs, "In1")
		lhs_loc, lhs_type = lhs_util(attrs, state, global_counters, lvars, comp_attrs, "a", "bf16", [64,64])
		dims = "{1, 0}"
		dims = dims.replace("'","")
		...
		print(f'transpose_13(addr_in,addr_out)')
		print([addr_in,addr_out])

def mov_21(n,addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
			"n": n,
	...
	if mode == 'fsim':
		...
		print(f'mov_21(n,addr_in,addr_out)')
		print([n,addr_in,addr_out])

def mov_23(n,addr_in,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
			"n": n,
	...
	if mode == 'fsim':
		...
		print(f'mov_23(n,addr_in,addr_out)')
		print([n,addr_in,addr_out])

def gemm_33(addr_1,addr_2,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
	...
	if mode == 'fsim':
		...
		print(f'gemm_33(addr_1,addr_2,addr_out)')
		print([addr_1,addr_2,addr_out])

def gemm_13(addr_1,addr_2,addr_out) -> None:
	global total_cost, instruction_scopes, cur_scope, comp_attrs, state, global_counters
	global_counters['loop_counter'] = 0
	comp_attrs = {
	...
	if mode == 'fsim':
		...
		print(f'gemm_13(addr_1,addr_2,addr_out)')
		print([addr_1,addr_2,addr_out])
