...
pub fn get_applier(rule: &str) -> Rewrite<TensorOp, TensorInfo> {
    ...
    let precond_fn = match name {
        "load-rm" => precond_load_rm,
        "load-cm" => precond_load_cm,
        "store-rm" => precond_store_rm,
        "store-cm" => precond_store_cm,
        "mov" => precond_mov,
        "gemm" => precond_gemm,
    ...
    let metadata_fn = match name {
        "load-rm" => metadata_load_rm,
        "load-cm" => metadata_load_cm,
        "store-rm" => metadata_store_rm,
        "store-cm" => metadata_store_cm,
        "mov" => metadata_mov,
        "gemm" => metadata_gemm,
    ...
    let set_shapes_fn = match name {
        "load-rm" => set_shapes_load_rm,
        "load-cm" => set_shapes_load_cm,
        "store-rm" => set_shapes_store_rm,
        "store-cm" => set_shapes_store_cm,
        "mov" => set_shapes_mov,
        "gemm" => set_shapes_gemm,
