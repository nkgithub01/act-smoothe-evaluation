...
public:
  LoadRm(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("load_rm", y, X), n(n) {
  }
...
class LoadCm : public Instruction {
private:
  int64 n;
...
public:
  LoadCm(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("load_cm", y, X), n(n) {
  }
...
class StoreRm : public Instruction {
private:
  int64 n;
...
public:
  StoreRm(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("store_rm", y, X), n(n) {
  }
...
class StoreCm : public Instruction {
private:
  int64 n;
...
public:
  StoreCm(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("store_cm", y, X), n(n) {
  }
...
public:
  Mov(Tensor *y, std::vector<Tensor *> X, int64 n)
      : Instruction("mov", y, X), n(n) {
  }
...
public:
  Gemm(Tensor *y, std::vector<Tensor *> X)
      : Instruction("gemm", y, X) {
  }
