...
pub fn get_applier(rule: &str) -> Rewrite<TensorOp, TensorInfo> {
    ...
    let precond_fn = match name {
        "load-01" => precond_load_01,
        "load-03" => precond_load_03,
        "store-10" => precond_store_10,
        "store-30" => precond_store_30,
        "transpose-13" => precond_transpose_13,
        "mov-21" => precond_mov_21,
        "mov-23" => precond_mov_23,
        "gemm-33" => precond_gemm_33,
        "gemm-13" => precond_gemm_13,
    ...
    let metadata_fn = match name {
        "load-01" => metadata_load_01,
        "load-03" => metadata_load_03,
        "store-10" => metadata_store_10,
        "store-30" => metadata_store_30,
        "transpose-13" => metadata_transpose_13,
        "mov-21" => metadata_mov_21,
        "mov-23" => metadata_mov_23,
        "gemm-33" => metadata_gemm_33,
        "gemm-13" => metadata_gemm_13,
    ...
    let set_shapes_fn = match name {
        "load-01" => set_shapes_load_01,
        "load-03" => set_shapes_load_03,
        "store-10" => set_shapes_store_10,
        "store-30" => set_shapes_store_30,
        "transpose-13" => set_shapes_transpose_13,
        "mov-21" => set_shapes_mov_21,
        "mov-23" => set_shapes_mov_23,
        "gemm-33" => set_shapes_gemm_33,
        "gemm-13" => set_shapes_gemm_13,
